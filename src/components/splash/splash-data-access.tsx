...
import { getSplashProgram } from "../../../anchor/src";
...
export function useSplashProgramAccount({ account }: { account: PublicKey }) {
  // const { cluster } = useCluster()
  const transactionToast = useTransactionToast();
  const { program, accounts } = useSplashProgram();
